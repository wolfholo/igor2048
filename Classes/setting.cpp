...
bool setting::init()
{
	...
	minus->alignItemsVerticallyWithPadding(visibleSize.height/5-visibleSize.width/7);
	...
	plus->setPosition(Vec2(visibleSize.width/4*3,
		                 visibleSize.height/2*1.1));
	plus->alignItemsVerticallyWithPadding(visibleSize.height/5-visibleSize.width/7);
